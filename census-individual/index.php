<?php
	...
	if(isset($_POST['submit'])){
		...
		$query = "INSERT INTO `popis_rezultati` (`jmbg`, `godiste`, `pol`, `nacija`, `jezik`, `vjera`, `posao`, `brak`, `id_dom`) VALUES ('$jmbg', '$godiste', '$pol', '$nacija', '$jezik', '$vjera', '$posao', '$brak', '$id_dom')";
        $query1 = "UPDATE popis_gradjani SET status = '1' WHERE jmbg = '$jmbg' ";
